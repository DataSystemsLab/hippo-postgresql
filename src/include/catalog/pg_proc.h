...
DATA(insert OID = 336 (  hippohandler	PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 325 "2281" _null_ _null_ _null_ _null_ _null_	hippohandler _null_ _null_ _null_ ));
DESCR("brin index access method handler");
