...
DATA(insert (   920411    20    20  1  469 ));
DATA(insert (   920411    20    20  2  471 ));
DATA(insert (   920411    20    20  3  467 ));
DATA(insert (   920411    20    20  4  472 ));
DATA(insert (   920411    20    20  5  470 ));

DATA(insert (   920411    21    21  1   64 ));
DATA(insert (   920411    21    21  2  148 ));
DATA(insert (   920411    21    21  3  63 ));
DATA(insert (   920411    21    21  4  151 ));
DATA(insert (   920411    21    21  5  146 ));

DATA(insert (   920411    23    23  1   66 ));
DATA(insert (   920411    23    23  2  149 ));
DATA(insert (   920411    23    23  3  65 ));
DATA(insert (   920411    23    23  4  150 ));
DATA(insert (   920411    23    23  5  147 ));



//DATA(insert (	920411	20	  20  1  3383 ));
//DATA(insert (	920411	20	  20  2  3384 ));
//DATA(insert (	920411	20	  20  3  3385 ));
//DATA(insert (	920411	20	  20  4  3386 ));
//DATA(insert (	920411	20	  21  1  3383 ));
//DATA(insert (	920411	20	  21  2  3384 ));
//DATA(insert (	920411	20	  21  3  3385 ));
//DATA(insert (	920411	20	  21  4  3386 ));
//DATA(insert (	920411	20	  23  1  3383 ));
//DATA(insert (	920411	20	  23  2  3384 ));
//DATA(insert (	920411	20	  23  3  3385 ));
//DATA(insert (	920411	20	  23  4  3386 ));

//DATA(insert (	920411	21	  21  1  3383 ));
//DATA(insert (	920411	21	  21  2  3384 ));
//DATA(insert (	920411	21	  21  3  3385 ));
//DATA(insert (	920411	21	  21  4  3386 ));
//DATA(insert (	920411	21	  20  1  3383 ));
//DATA(insert (	920411	21	  20  2  3384 ));
//DATA(insert (	920411	21	  20  3  3385 ));
//DATA(insert (	920411	21	  20  4  3386 ));
//DATA(insert (	920411	21	  23  1  3383 ));
//DATA(insert (	920411	21	  23  2  3384 ));
//DATA(insert (	920411	21	  23  3  3385 ));
//DATA(insert (	920411	21	  23  4  3386 ));

//DATA(insert (	920411	23	  23  1  3383 ));
//DATA(insert (	920411	23	  23  2  3384 ));
//DATA(insert (	920411	23	  23  3  3385 ));
//DATA(insert (	920411	23	  23  4  3386 ));
//DATA(insert (	920411	23	  20  1  3383 ));
//DATA(insert (	920411	23	  20  2  3384 ));
//DATA(insert (	920411	23	  20  3  3385 ));
//DATA(insert (	920411	23	  20  4  3386 ));
//DATA(insert (	920411	23	  21  1  3383 ));
//DATA(insert (	920411	23	  21  2  3384 ));
//DATA(insert (	920411	23	  21  3  3385 ));
//DATA(insert (	920411	23	  21  4  3386 ));
